...
for (const file of ['index.html', 'styles.css', 'chat-shell.css', 'image-preview.css', 'p8-inspect.css', 'app.mjs', 'chat-shell.mjs', 'icon-source.mjs', 'p8-inspect.mjs', 'pwa-boundaries.mjs', 'recycle-confirmation.mjs']) await cp(resolve(root, 'src', file), resolve(dist, file));
