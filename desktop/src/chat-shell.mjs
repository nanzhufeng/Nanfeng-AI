...
function settingsCenterCanvas(dualPath, status, data, native, p6eAcceptance = { enabled: false, receipt: null }, p6gCatalog = null, p6gGlobalDefault = null, section = 'data', search = '', p6kTask = null, p6kLink = {}) {
  ...
  const content = section === 'model' ? modelContent : section === 'ai-model-service' ? aiModelServiceContent : section === 'feature-review' ? featureReviewContent : section === 'privacy' ? privacyContent : section === 'general' ? generalContent : `${dataContent}${v2WorkspaceExchangeRow}${p6jImportRow}${p6kZipRow}`;
