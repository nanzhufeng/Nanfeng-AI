...
function settingsCenterCanvas(dualPath, status, data, native, p6eAcceptance = { enabled: false, receipt: null }, p6gCatalog = null, p6gGlobalDefault = null, section = 'data', search = '', p6kTask = null, p6kLink = {}) {
  ...
  const v2WorkspaceExchangeRow = `<section class="settings-section"><h2>完整工作区交换（v2）</h2><article class="settings-row"><div><strong>私有 v2 导入</strong><p>仅读取您选择的 .nfai-exchange；严格预检后写入独立私有归档与回执，不合并、覆盖或恢复为当前 Desktop 工作区。</p><small>device · local-only · private archive · receipt</small></div><div class="settings-row-controls"><button data-action="select-v2-workspace-exchange" ${native ? '' : 'disabled'}>选择 v2 交换包</button></div></article></section>`;
