...
export function renderDesktopSearchPage({ query = '', category = 'all', sortMode = 'default', fileType = 'all', fileTypeOpen = false, page = { hits: [], textCount: 0, attachmentCount: 0 }, loading = false, error = '', evidenceLabel = '', history = [], historyOpen = false, historyHighlighted = null, thumbnails = {}, videoThumbnails = {}, attachmentPreviews = {} } = {}) {
